    ...
    <div className="max-w-md mx-auto bg-white bg-opacity-80 shadow-2xl rounded-lg p-6">
      <form>
        <div className="mb-4">
          ...
          <div className="flex space-x-4">
            <label className="flex items-center space-x-2">
              <input type="radio" name="pwd" value="false" className="text-blue-600" />
              <span>No</span>
            </label>
            <label className="flex items-center space-x-2">
              <input type="radio" name="pwd" value="true" className="text-blue-600" />
              <span>Yes</span>
            </label>
          </div>
        </div>
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700" htmlFor="annualFee">
            Annual Fee Budget (INR)
          </label>
          <input
            type="number"
        ...
        <div>
          <h6 className="text-lg font-medium text-gray-800 mb-4">Parent's Occupation</h6>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700" htmlFor="motherOccupation">
              Mother's Occupation
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700" htmlFor="fatherOccupation">
              Father's Occupation
            </label>
            <input
              type="text"
