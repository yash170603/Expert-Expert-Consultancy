        ...
        <div className="py-8">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a
                  href="mailto:expertec104@gmail.com"
                  target="_blank"
                  className="flex items-center space-x-3 text-gray-300 hover:text-yellow-400 transition-colors"
                >
                  <FaEnvelope className="w-4 h-4" />
                  <span>expertec104@gmail.com</span>
                </a>
                <a
                  href="https://www.myadmissionexpert.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-yellow-400 transition-colors"
                >
                  <TbWorldWww className="w-5 h-5" />
                  <span>www.myadmissionexpert.com</span>
                </a>
                ...
                >
                  ...
                  <span>+91 8803111124</span>
                </a>
                <a
                  href="https://wa.me/9313555010"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-yellow-400 transition-colors"
                >
                  <FaWhatsapp className="w-4 h-4" />
                  <span> 93135 55010</span>
                </a>

                <a
                  href="https://www.google.com/maps/place/Expert+Educational+Consultancy+Estd.+1995/@28.712546,77.1371463,17z/data=!3m1!4b1!4m6!3m5!1s0x390d017caca5521d:0xfab588b644feabdd!8m2!3d28.712546!4d77.1371463!16s%2Fg%2F1tf34b9f?entry=ttu&g_ep=EgoyMDI1MDExNC4wIKXMDSoASAFQAw%3D%3D"
                ...
                >
                  ...
                  <span className="hover:text-yellow-400 text-sm">
                    H.O.: 104, Aditya Complex 2, D-Block, Central Market,
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300">
                Get daily updates about our services
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 mb-4">
                <a
                  href="https://www.facebook.com/people/Expert-Educational-Consultancy-Estd1995/100067182972359/?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.instagram.com/experteducationalconsultancy/?hl=en"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
                >
          ...
          <div className="mt-8 pt-4 border-t border-white/10">
            <p className="text-center text-gray-400 text-xs">
              © {new Date().getFullYear()} Expert Educational Consultancy. All
              rights reserved.
            </p>
          </div>
        </div>
